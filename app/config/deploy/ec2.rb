...
set :adminserver, "pdladmin1"
set :staticserver, "pdlstatic1.pompdelux.com"

set :branch, "master"

# list of servers to deploy to
role :app, 'pdlweb1', 'pdlweb2', 'pdlweb3', 'pdlweb4', 'pdladmin1', 'pdlstatic1.pompdelux.com'

# :symfonyweb should contain our apache/nginx servers running symfony. Used in reload_apache and opcode-clear
role :symfonyweb, 'pdlweb1', 'pdlweb2', 'pdlweb3', 'pdlweb4', 'pdladmin1'
