$(function() {
  ...
  if ($('div#flowplayer-container').length) {
    ...
    $('a#flowplayer').parent().before('<button href="#" rel="div.overlay" id="pop-flowplayer"> <img src="" alt="" class="thumb" /> <img src="'+cdn_url+'/fx/scripts/flowplayer/play.png" alt="" class="play" /> video </button>');
    ...
    var player = $f("flowplayer", cdn_url+'/fx/scripts/flowplayer/flowplayer.commercial-3.2.7.swf', {
      wmode: 'opaque',
  ...
  $('div#cms-page a[href*=".flv"]').each(function() {
    $f(this, {src : cdn_url+'/fx/scripts/flowplayer/flowplayer.commercial-3.2.7.swf'}, {
      wmode: 'opaque',
      key : [ '#@abc69980d87e1bdf4c0', '#@7420e35e69f7d145217', '#@c653c42454bc68842d6', '#@bed07fa279e220368ee' ],
      clip : {
        url : this.href,
