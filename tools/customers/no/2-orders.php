...
mysql_query("TRUNCATE TABLE {$to}.orders") or (die('Line: '.__LINE__."\n".mysql_error()."\n"."TRUNCATE TABLE {$to}.orders"));
mysql_query("TRUNCATE TABLE {$to}.orders_lines") or (die('Line: '.__LINE__."\n".mysql_error()."\n"."TRUNCATE TABLE {$to}.orders_lines"));
mysql_query("TRUNCATE TABLE {$to}.orders_attributes") or (die('Line: '.__LINE__."\n".mysql_error()."\n"."TRUNCATE TABLE {$to}.orders_attributes"));
...
mysql_query("ALTER TABLE {$to}.orders AUTO_INCREMENT = 130000");
