...
mysql_query("UPDATE {$from_db}.osc_simple_cms SET id = 10 WHERE id = 6") or (die('Line: '.__LINE__."\n".mysql_error()."\n"));
mysql_query("UPDATE {$from_db}.osc_simple_cms_i18n SET menu_id = 10 WHERE menu_id = 6") or (die('Line: '.__LINE__."\n".mysql_error()."\n"));
mysql_query("UPDATE {$from_db}.osc_simple_cms_item SET menu_id = 10 WHERE menu_id = 6") or (die('Line: '.__LINE__."\n".mysql_error()."\n"));
