...
abstract class BaseCategoriesI18nPeer
{
    ...
    const TM_CLASS = 'Hanzo\\Model\\map\\CategoriesI18nTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of CategoriesI18n objects.
     ...
     * e.g. CategoriesI18nPeer::$fieldNames[CategoriesI18nPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Locale', 'Title', 'Content', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'locale', 'title', 'content', ),
        BasePeer::TYPE_COLNAME => array (CategoriesI18nPeer::ID, CategoriesI18nPeer::LOCALE, CategoriesI18nPeer::TITLE, CategoriesI18nPeer::CONTENT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CategoriesI18nPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (CategoriesI18nPeer::ID => 0, CategoriesI18nPeer::LOCALE => 1, CategoriesI18nPeer::TITLE => 2, CategoriesI18nPeer::CONTENT => 3, ),
    ...
    {
        $toNames = CategoriesI18nPeer::getFieldNames($toType);
        $key = isset(CategoriesI18nPeer::$fieldKeys[$fromType][$name]) ? CategoriesI18nPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CategoriesI18nPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CategoriesI18nPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CategoriesI18nPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CategoriesI18nPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CategoriesI18nPeer::DATABASE_NAME);
     ...
     *
     * @param CategoriesI18n $obj A CategoriesI18n object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CategoriesI18nPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(CategoriesI18nPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CategoriesI18nPeer::$instances[$key])) {
                return CategoriesI18nPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (CategoriesI18nPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        CategoriesI18nPeer::$instances = array();
    }
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = CategoriesI18nPeer::getOMClass();
    ...
    {
        return Propel::getDatabaseMap(CategoriesI18nPeer::DATABASE_NAME)->getTable(CategoriesI18nPeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCategoriesI18nPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Hanzo\Model\map\CategoriesI18nTableMap());
      }
    }
    ...
    {
        return CategoriesI18nPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CategoriesI18nPeer::DATABASE_NAME);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseCategoriesI18nPeer'));
