...
abstract class BaseConsultantNewsletterDraftsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\ConsultantNewsletterDrafts', $modelAlias = null)
	{
	...
	public static function create($modelAlias = null, $criteria = null)
	{
		...
		$query = new ConsultantNewsletterDraftsQuery();
		if (null !== $modelAlias) {
	 ...
	 *
	 * @return    ConsultantNewsletterDrafts|array|mixed the result, formatted by the current formatter
	 */
...
} // BaseConsultantNewsletterDraftsQuery