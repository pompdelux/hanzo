...
abstract class BaseCmsThreadI18nQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\CmsThreadI18n', $modelAlias = null)
	{
	 ...
	 *
	 * @return    CmsThreadI18n|array|mixed the result, formatted by the current formatter
	 */
