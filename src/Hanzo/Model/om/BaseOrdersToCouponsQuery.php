...
abstract class BaseOrdersToCouponsQuery extends ModelCriteria
{
	 ...
	 * </code>
	 *
	 * @param     array[$orders_id, $coupons_id] $key Primary key to use for the query
	 * @param     PropelPDO $con an optional connection object
	 *
	 * @return    OrdersToCoupons|array|mixed the result, formatted by the current formatter
	 */
