...
abstract class BaseCmsThreadI18n extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\CmsThreadI18nPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CmsThreadI18nPeer
     */
    ...
    /**
     * Initializes internal state of BaseCmsThreadI18n object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CmsThreadI18nPeer::ID;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[] = CmsThreadI18nPeer::LOCALE;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = CmsThreadI18nPeer::TITLE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating CmsThreadI18n object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCmsThread !== null && $this->id !== $this->aCmsThread->getId()) {
            $this->aCmsThread = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CmsThreadI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `cms_thread_i18n` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CmsThreadI18nPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CmsThreadI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CmsThreadI18n'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CmsThreadI18n'][serialize($this->getPrimaryKey())] = true;
        $keys = CmsThreadI18nPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CmsThreadI18nPeer::ID)) $criteria->add(CmsThreadI18nPeer::ID, $this->id);
        if ($this->isColumnModified(CmsThreadI18nPeer::LOCALE)) $criteria->add(CmsThreadI18nPeer::LOCALE, $this->locale);
        if ($this->isColumnModified(CmsThreadI18nPeer::TITLE)) $criteria->add(CmsThreadI18nPeer::TITLE, $this->title);
    ...
    {
        $criteria = new Criteria(CmsThreadI18nPeer::DATABASE_NAME);
        $criteria->add(CmsThreadI18nPeer::ID, $this->id);
        $criteria->add(CmsThreadI18nPeer::LOCALE, $this->locale);
     ...
     * objects.
     *
     * @param object $copyObj An object of CmsThreadI18n (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CmsThreadI18n Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CmsThreadI18nPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CmsThreadI18nPeer();
        }
    ...
    public function getCmsThread(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCmsThread === null && ($this->id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCmsThread->addCmsThreadI18ns($this);
             */
        }
