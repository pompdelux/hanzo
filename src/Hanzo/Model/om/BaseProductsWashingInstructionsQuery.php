...
abstract class BaseProductsWashingInstructionsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\ProductsWashingInstructions', $modelAlias = null)
	{
	...
	public static function create($modelAlias = null, $criteria = null)
	{
		...
		$query = new ProductsWashingInstructionsQuery();
		if (null !== $modelAlias) {
	 ...
	 *
	 * @return    ProductsWashingInstructions|array|mixed the result, formatted by the current formatter
	 */
...
} // BaseProductsWashingInstructionsQuery