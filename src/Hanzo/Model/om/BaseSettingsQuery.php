...
abstract class BaseSettingsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\Settings', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Settings|array|mixed the result, formatted by the current formatter
	 */
