...
abstract class BaseZipToCity extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\ZipToCityPeer';
    ...
    /**
     * The value for the countries_iso2 field.
     * @var        string
     */
    protected $countries_iso2;
    ...
    /**
     * Get the [countries_iso2] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ZipToCityPeer::ID;
        }
    ...
    public function setZip($v)
    {
        ...
        if ($this->zip !== $v) {
            $this->zip = $v;
            $this->modifiedColumns[] = ZipToCityPeer::ZIP;
        }
    ...
    public function setCountriesIso2($v)
    {
        ...
        if ($this->countries_iso2 !== $v) {
            $this->countries_iso2 = $v;
            $this->modifiedColumns[] = ZipToCityPeer::COUNTRIES_ISO2;
        }

        if ($this->aCountries !== null && $this->aCountries->getIso2() !== $v) {
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[] = ZipToCityPeer::CITY;
        }
    ...
    public function setCountyId($v)
    {
        ...
        if ($this->county_id !== $v) {
            $this->county_id = $v;
            $this->modifiedColumns[] = ZipToCityPeer::COUNTY_ID;
        }
    ...
    public function setCountyName($v)
    {
        ...
        if ($this->county_name !== $v) {
            $this->county_name = $v;
            $this->modifiedColumns[] = ZipToCityPeer::COUNTY_NAME;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->comment !== $v) {
            $this->comment = $v;
            $this->modifiedColumns[] = ZipToCityPeer::COMMENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->zip = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->countries_iso2 = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->city = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->county_id = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->county_name = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            throw new PropelException("Error populating ZipToCity object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCountries !== null && $this->countries_iso2 !== $this->aCountries->getIso2()) {
            $this->aCountries = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ZipToCityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ZipToCityQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ZipToCityPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `zip_to_city` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ZipToCityPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ZipToCityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ZipToCity'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ZipToCity'][$this->getPrimaryKey()] = true;
        $keys = ZipToCityPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getZip(),
            $keys[2] => $this->getCountriesIso2(),
            $keys[3] => $this->getCity(),
            $keys[4] => $this->getCountyId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setZip($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCountriesIso2($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCity($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setCountyId($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setCountyName($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ZipToCityPeer::ID)) $criteria->add(ZipToCityPeer::ID, $this->id);
        if ($this->isColumnModified(ZipToCityPeer::ZIP)) $criteria->add(ZipToCityPeer::ZIP, $this->zip);
        if ($this->isColumnModified(ZipToCityPeer::COUNTRIES_ISO2)) $criteria->add(ZipToCityPeer::COUNTRIES_ISO2, $this->countries_iso2);
        if ($this->isColumnModified(ZipToCityPeer::CITY)) $criteria->add(ZipToCityPeer::CITY, $this->city);
        if ($this->isColumnModified(ZipToCityPeer::COUNTY_ID)) $criteria->add(ZipToCityPeer::COUNTY_ID, $this->county_id);
        if ($this->isColumnModified(ZipToCityPeer::COUNTY_NAME)) $criteria->add(ZipToCityPeer::COUNTY_NAME, $this->county_name);
        if ($this->isColumnModified(ZipToCityPeer::COMMENT)) $criteria->add(ZipToCityPeer::COMMENT, $this->comment);
    ...
    {
        $criteria = new Criteria(ZipToCityPeer::DATABASE_NAME);
        $criteria->add(ZipToCityPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ZipToCity (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setCountriesIso2($this->getCountriesIso2());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ZipToCity Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ZipToCityPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ZipToCityPeer();
        }
    ...
    {
        if ($v === null) {
            $this->setCountriesIso2(NULL);
        } else {
            $this->setCountriesIso2($v->getIso2());
        }
    ...
    {
        return (string) $this->exportTo(ZipToCityPeer::DEFAULT_STRING_FORMAT);
    }
