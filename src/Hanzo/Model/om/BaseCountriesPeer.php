...
abstract class BaseCountriesPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::LOCAL_NAME, self::CODE, self::ISO2, self::ISO3, self::CONTINENT, self::CURRENCY_ID, self::CURRENCY_CODE, self::CURRENCY_NAME, self::VAT, self::CALLING_CODE, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::LOCAL_NAME => 2, self::CODE => 3, self::ISO2 => 4, self::ISO3 => 5, self::CONTINENT => 6, self::CURRENCY_ID => 7, self::CURRENCY_CODE => 8, self::CURRENCY_NAME => 9, self::VAT => 10, self::CALLING_CODE => 11, ),
