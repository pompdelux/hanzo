...
abstract class BaseAddressesQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\Addresses', $modelAlias = null)
	{
	 ...
	 * </code>
	 *
	 * @param     array[$customers_id, $type] $key Primary key to use for the query
	 * @param     PropelPDO $con an optional connection object
	 *
	 * @return    Addresses|array|mixed the result, formatted by the current formatter
	 */
