...
abstract class BaseProductsDomainsPricesPeer
{
    ...
    const TM_CLASS = 'Hanzo\\Model\\map\\ProductsDomainsPricesTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of ProductsDomainsPrices objects.
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseProductsDomainsPricesPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Hanzo\Model\map\ProductsDomainsPricesTableMap());
      }
    }
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseProductsDomainsPricesPeer'));
