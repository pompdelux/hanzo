...
abstract class BaseWishlistsLines extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\WishlistsLinesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        WishlistsLinesPeer
     */
    ...
    /**
     * The value for the wishlists_id field.
     * @var        string
     */
    protected $wishlists_id;
    ...
    /**
     * Get the [wishlists_id] column value.
     *
     * @return string
     */
    public function getWishlistsId()
    {

        return $this->wishlists_id;
    }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = WishlistsLinesPeer::ID;
        }
    ...
    /**
     * Set the value of [wishlists_id] column.
     *
     * @param  string $v new value
     * @return WishlistsLines The current object (for fluent API support)
     */
    public function setWishlistsId($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->wishlists_id !== $v) {
            $this->wishlists_id = $v;
            $this->modifiedColumns[] = WishlistsLinesPeer::WISHLISTS_ID;
        }

        if ($this->aWishlists !== null && $this->aWishlists->getId() !== $v) {
            $this->aWishlists = null;
        }
    ...
    public function setProductsId($v)
    {
        ...
        if ($this->products_id !== $v) {
            $this->products_id = $v;
            $this->modifiedColumns[] = WishlistsLinesPeer::PRODUCTS_ID;
        }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[] = WishlistsLinesPeer::QUANTITY;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aWishlists !== null && $this->wishlists_id !== $this->aWishlists->getId()) {
            $this->aWishlists = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = WishlistsLinesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $deleteQuery = WishlistsLinesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                WishlistsLinesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aWishlists !== null) {
                if ($this->aWishlists->isModified() || $this->aWishlists->isNew()) {
                    $affectedRows += $this->aWishlists->save($con);
                }
                $this->setWishlists($this->aWishlists);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(WishlistsLinesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(WishlistsLinesPeer::WISHLISTS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`wishlists_id`';
        }
        ...
        $sql = sprintf(
            'INSERT INTO `wishlists_lines` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`wishlists_id`':
                        $stmt->bindValue($identifier, $this->wishlists_id, PDO::PARAM_STR);
                        break;
                    case '`products_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aWishlists !== null) {
                if (!$this->aWishlists->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aWishlists->getValidationFailures());
                }
            }
            ...
            if (($retval = WishlistsLinesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = WishlistsLinesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['WishlistsLines'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WishlistsLines'][$this->getPrimaryKey()] = true;
        $keys = WishlistsLinesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aWishlists) {
                $result['Wishlists'] = $this->aWishlists->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    {
        $criteria = new Criteria(WishlistsLinesPeer::DATABASE_NAME);
        $criteria->add(WishlistsLinesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of WishlistsLines (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return WishlistsLines Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return WishlistsLinesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new WishlistsLinesPeer();
        }
    ...
    /**
     * Declares an association between this object and a Wishlists object.
     *
     * @param                  Wishlists $v
     * @return WishlistsLines The current object (for fluent API support)
     * @throws PropelException
     */
    public function setWishlists(Wishlists $v = null)
    {
        if ($v === null) {
            $this->setWishlistsId(NULL);
        } else {
            $this->setWishlistsId($v->getId());
        }

        $this->aWishlists = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Wishlists object, it will not be re-added.
        if ($v !== null) {
            $v->addWishlistsLines($this);
        }
    ...
    /**
     * Get the associated Wishlists object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Wishlists The associated Wishlists object.
     * @throws PropelException
     */
    public function getWishlists(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aWishlists === null && (($this->wishlists_id !== "" && $this->wishlists_id !== null)) && $doQuery) {
            $this->aWishlists = WishlistsQuery::create()->findPk($this->wishlists_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWishlists->addWishlistsLiness($this);
             */
        }

        return $this->aWishlists;
    }
    ...
    public function getProducts(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProducts === null && ($this->products_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProducts->addWishlistsLiness($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aWishlists instanceof Persistent) {
              $this->aWishlists->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(WishlistsLinesPeer::DEFAULT_STRING_FORMAT);
    }
