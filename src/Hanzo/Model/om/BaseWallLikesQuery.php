...
abstract class BaseWallLikesQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\WallLikes', $modelAlias = null)
	{
	 ...
	 *
	 * @return    WallLikes|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     Wall|PropelCollection $wall The related object(s) to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    WallLikesQuery The current query, for fluid interface
	 */
