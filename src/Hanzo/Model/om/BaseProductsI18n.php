...
/**
 * Base class that represents a row from the 'products_i18n' table.
 *
 * 
 *
 * @package    propel.generator.src.Hanzo.Model.om
 */
abstract class BaseProductsI18n extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Hanzo\\Model\\ProductsI18nPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ProductsI18nPeer
	 */
	...
	/**
	 * Initializes internal state of BaseProductsI18n object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ProductsI18nPeer::ID;
		}
	...
	public function setLocale($v)
	{
		...
		if ($this->locale !== $v) {
			$this->locale = $v;
			$this->modifiedColumns[] = ProductsI18nPeer::LOCALE;
		}
	...
	public function setTitle($v)
	{
		...
		if ($this->title !== $v) {
			$this->title = $v;
			$this->modifiedColumns[] = ProductsI18nPeer::TITLE;
		}
	...
	public function setContent($v)
	{
		...
		if ($this->content !== $v) {
			$this->content = $v;
			$this->modifiedColumns[] = ProductsI18nPeer::CONTENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			throw new PropelException("Error populating ProductsI18n object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aProducts !== null && $this->id !== $this->aProducts->getId()) {
			$this->aProducts = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProductsI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProductsI18nQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProductsI18nPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		$sql = sprintf(
			'INSERT INTO `products_i18n` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProductsI18nPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ProductsI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['ProductsI18n'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProductsI18n'][serialize($this->getPrimaryKey())] = true;
		$keys = ProductsI18nPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductsI18nPeer::ID)) $criteria->add(ProductsI18nPeer::ID, $this->id);
		if ($this->isColumnModified(ProductsI18nPeer::LOCALE)) $criteria->add(ProductsI18nPeer::LOCALE, $this->locale);
		if ($this->isColumnModified(ProductsI18nPeer::TITLE)) $criteria->add(ProductsI18nPeer::TITLE, $this->title);
		if ($this->isColumnModified(ProductsI18nPeer::CONTENT)) $criteria->add(ProductsI18nPeer::CONTENT, $this->content);
	...
	{
		$criteria = new Criteria(ProductsI18nPeer::DATABASE_NAME);
		$criteria->add(ProductsI18nPeer::ID, $this->id);
		$criteria->add(ProductsI18nPeer::LOCALE, $this->locale);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProductsI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProductsI18n Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProductsI18nPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProductsI18nPeer();
		}
		return self::$peer;
	}
	...
	public function getProducts(PropelPDO $con = null)
	{
		if ($this->aProducts === null && ($this->id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aProducts->addProductsI18ns($this);
			 */
		}
