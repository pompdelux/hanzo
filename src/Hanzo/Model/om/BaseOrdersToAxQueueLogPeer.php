...
abstract class BaseOrdersToAxQueueLogPeer
{
    ...
    public static function doCountJoinOrders(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrdersToAxQueueLogPeer::ORDERS_ID, OrdersPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of OrdersToAxQueueLog objects pre-filled with their Orders objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of OrdersToAxQueueLog objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinOrders(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        OrdersToAxQueueLogPeer::addSelectColumns($criteria);
        $startcol = OrdersToAxQueueLogPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = OrdersToAxQueueLogPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = OrdersToAxQueueLogPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                OrdersToAxQueueLogPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (OrdersToAxQueueLog) to $obj2 (Orders)
                $obj2->addOrdersToAxQueueLog($obj1);
    ...
    /**
     * Selects a collection of OrdersToAxQueueLog objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        OrdersToAxQueueLogPeer::addSelectColumns($criteria);
        $startcol2 = OrdersToAxQueueLogPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (OrdersToAxQueueLog) to the collection in $obj2 (Orders)
                $obj2->addOrdersToAxQueueLog($obj1);
