...
abstract class BaseProductsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\Products', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Products|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     MannequinImages $mannequinImages  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	 ...
	 * Filter the query by a related Products object
	 *
	 * @param     Products $products  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	 ...
	 *
	 * @param     ProductsDomainsPrices $productsDomainsPrices  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	public function filterByProductsDomainsPrices($productsDomainsPrices, $comparison = null)
	{
		...
		} elseif ($productsDomainsPrices instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     ProductsImages $productsImages  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	 ...
	 *
	 * @param     ProductsStock $productsStock  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	public function filterByProductsStock($productsStock, $comparison = null)
	{
		...
		} elseif ($productsStock instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     ProductsToCategories $productsToCategories  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	public function filterByProductsToCategories($productsToCategories, $comparison = null)
	{
		...
		} elseif ($productsToCategories instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     OrdersLines $ordersLines  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	public function filterByOrdersLines($ordersLines, $comparison = null)
	{
		...
		} elseif ($ordersLines instanceof PropelCollection) {
			return $this
				->useOrdersLinesQuery()
	 ...
	 *
	 * @param     RelatedProducts $relatedProducts  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	public function filterByRelatedProductsRelatedByMaster($relatedProducts, $comparison = null)
	{
		...
		} elseif ($relatedProducts instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     ProductsI18n $productsI18n  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    ProductsQuery The current query, for fluid interface
	 */
	public function filterByProductsI18n($productsI18n, $comparison = null)
	{
		...
		} elseif ($productsI18n instanceof PropelCollection) {
			return $this
