...
abstract class BaseCmsThread extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array CmsThreadI18n[] Collection to store aggregation of CmsThreadI18n objects.
	 */
	...
	{
		if ('Cms' == $relationName) {
			return $this->initCmss();
		}
		if ('CmsThreadI18n' == $relationName) {
			return $this->initCmsThreadI18ns();
		}
	}
	...
	{
		if(null === $this->collCmss || null !== $criteria) {
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array CmsThreadI18n[] List of CmsThreadI18n objects
	 * @throws     PropelException
	 */
	public function getCmsThreadI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collCmsThreadI18ns || null !== $criteria) {
