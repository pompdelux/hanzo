...
abstract class BaseProductsToCategoriesPeer
{
     ...
     * e.g. ProductsToCategoriesPeer::$fieldNames[ProductsToCategoriesPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ProductsId', 'CategoriesId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('productsId', 'categoriesId', ),
        BasePeer::TYPE_COLNAME => array (ProductsToCategoriesPeer::PRODUCTS_ID, ProductsToCategoriesPeer::CATEGORIES_ID, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ProductsToCategoriesPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProductsToCategoriesPeer::PRODUCTS_ID => 0, ProductsToCategoriesPeer::CATEGORIES_ID => 1, ),
    ...
    {
        $toNames = ProductsToCategoriesPeer::getFieldNames($toType);
        $key = isset(ProductsToCategoriesPeer::$fieldKeys[$fromType][$name]) ? ProductsToCategoriesPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ProductsToCategoriesPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ProductsToCategoriesPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ProductsToCategoriesPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ProductsToCategoriesPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ProductsToCategoriesPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ProductsToCategoriesPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ProductsToCategoriesPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ProductsToCategoriesPeer::$instances[$key])) {
                return ProductsToCategoriesPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(ProductsToCategoriesPeer::DATABASE_NAME)->getTable(ProductsToCategoriesPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ProductsToCategoriesPeer::DATABASE_NAME);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseProductsToCategoriesPeer'));
