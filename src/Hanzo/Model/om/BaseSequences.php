...
abstract class BaseSequences extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\SequencesPeer';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = SequencesPeer::NAME;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SequencesPeer::ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SequencesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SequencesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SequencesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `sequences` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Sequences'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Sequences'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SequencesPeer::NAME)) $criteria->add(SequencesPeer::NAME, $this->name);
        if ($this->isColumnModified(SequencesPeer::ID)) $criteria->add(SequencesPeer::ID, $this->id);
    ...
    {
        $criteria = new Criteria(SequencesPeer::DATABASE_NAME);
        $criteria->add(SequencesPeer::NAME, $this->name);
    ...
    {
        return (string) $this->exportTo(SequencesPeer::DEFAULT_STRING_FORMAT);
    }
