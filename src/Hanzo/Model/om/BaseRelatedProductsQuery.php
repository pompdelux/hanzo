...
abstract class BaseRelatedProductsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\RelatedProducts', $modelAlias = null)
	{
	...
	public static function create($modelAlias = null, $criteria = null)
	{
		...
		$query = new RelatedProductsQuery();
		if (null !== $modelAlias) {
	 ...
	 * </code>
	 *
	 * @param     array[$master, $sku] $key Primary key to use for the query
	 * @param     PropelPDO $con an optional connection object
	 *
	 * @return    RelatedProducts|array|mixed the result, formatted by the current formatter
	 */
