...
abstract class BaseDomains extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array DomainsSettings[] Collection to store aggregation of DomainsSettings objects.
	 */
	...
	public function initRelation($relationName)
	{
		if ('DomainsSettings' == $relationName) {
			return $this->initDomainsSettingss();
		}
	 ...
	 * @return     PropelCollection|array DomainsSettings[] List of DomainsSettings objects
	 * @throws     PropelException
	 */
	public function getDomainsSettingss($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collDomainsSettingss || null !== $criteria) {
