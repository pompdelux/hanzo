...
abstract class BaseConsultantsPeer
{
     ...
     * e.g. ConsultantsPeer::$fieldNames[ConsultantsPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ConsultantsPeer::INITIALS, ConsultantsPeer::INFO, ConsultantsPeer::EVENT_NOTES, ConsultantsPeer::HIDE_INFO, ConsultantsPeer::MAX_NOTIFIED, ConsultantsPeer::ID, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ConsultantsPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ConsultantsPeer::INITIALS => 0, ConsultantsPeer::INFO => 1, ConsultantsPeer::EVENT_NOTES => 2, ConsultantsPeer::HIDE_INFO => 3, ConsultantsPeer::MAX_NOTIFIED => 4, ConsultantsPeer::ID => 5, ),
    ...
    {
        $toNames = ConsultantsPeer::getFieldNames($toType);
        $key = isset(ConsultantsPeer::$fieldKeys[$fromType][$name]) ? ConsultantsPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ConsultantsPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ConsultantsPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ConsultantsPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ConsultantsPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ConsultantsPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            ConsultantsPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ConsultantsPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ConsultantsPeer::$instances[$key])) {
                return ConsultantsPeer::$instances[$key];
            }
        }
    ...
    {
        return Propel::getDatabaseMap(ConsultantsPeer::DATABASE_NAME)->getTable(ConsultantsPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ConsultantsPeer::DATABASE_NAME);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseConsultantsPeer'));
