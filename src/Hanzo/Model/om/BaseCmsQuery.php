...
abstract class BaseCmsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\Cms', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Cms|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     CmsThread|PropelCollection $cmsThread The related object(s) to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    CmsQuery The current query, for fluid interface
	 */
	public function filterByCmsThread($cmsThread, $comparison = null)
	{
		...
		} elseif ($cmsThread instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this
	 ...
	 * Filter the query by a related Cms object
	 *
	 * @param     Cms $cms  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    CmsQuery The current query, for fluid interface
	 */
	 ...
	 *
	 * @param     CmsI18n $cmsI18n  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    CmsQuery The current query, for fluid interface
	 */
	public function filterByCmsI18n($cmsI18n, $comparison = null)
	{
		...
		} elseif ($cmsI18n instanceof PropelCollection) {
			return $this
				->useCmsI18nQuery()
