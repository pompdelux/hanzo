...
abstract class BaseMessages extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array MessagesI18n[] Collection to store aggregation of MessagesI18n objects.
	 */
	 ...
	 * @return     PropelCollection|array MessagesI18n[] List of MessagesI18n objects
	 * @throws     PropelException
	 */
	public function getMessagesI18ns($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collMessagesI18ns || null !== $criteria) {
