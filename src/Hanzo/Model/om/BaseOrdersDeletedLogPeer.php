...
abstract class BaseOrdersDeletedLogPeer {
	...
	const TM_CLASS = 'OrdersDeletedLogTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of OrdersDeletedLog objects.
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ORDERS_ID, self::CUSTOMERS_ID, self::NAME, self::EMAIL, self::TRIGGER, self::CONTENT, self::DELETED_BY, self::DELETED_AT, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ORDERS_ID => 0, self::CUSTOMERS_ID => 1, self::NAME => 2, self::EMAIL => 3, self::TRIGGER => 4, self::CONTENT => 5, self::DELETED_BY => 6, self::DELETED_AT => 7, ),
	 ...
	 *
	 * @param      OrdersDeletedLog $value A OrdersDeletedLog object.
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new OrdersDeletedLogTableMap());
	  }
	}
