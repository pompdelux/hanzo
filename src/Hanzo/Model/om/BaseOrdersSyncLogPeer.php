...
abstract class BaseOrdersSyncLogPeer {
	...
	const CLASS_DEFAULT = 'home/un/Documents/Arbejde/Pompdelux/www/hanzo/Symfony/src/Hanzo/Model.OrdersSyncLog';
	...
	/**
	 * An identiy map to hold any loaded instances of OrdersSyncLog objects.
	 ...
	 *
	 * @param      OrdersSyncLog $value A OrdersSyncLog object.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = OrdersSyncLogPeer::getOMClass(false);
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new OrdersSyncLogTableMap());
	  }
	}
	...
	{
		return $withPrefix ? OrdersSyncLogPeer::CLASS_DEFAULT : OrdersSyncLogPeer::OM_CLASS;
	}
