...
abstract class BaseMessagesI18nQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\MessagesI18n', $modelAlias = null)
	{
	 ...
	 *
	 * @return    MessagesI18n|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     Messages|PropelCollection $messages The related object(s) to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    MessagesI18nQuery The current query, for fluid interface
	 */
	public function filterByMessages($messages, $comparison = null)
	{
		...
		} elseif ($messages instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this
