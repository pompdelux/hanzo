...
abstract class BaseProductsDomainsPrices extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'Hanzo\\Model\\ProductsDomainsPricesPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ProductsDomainsPricesPeer
	 */
	...
	public function setProductsId($v)
	{
		...
		if ($this->products_id !== $v) {
			$this->products_id = $v;
			$this->modifiedColumns[] = ProductsDomainsPricesPeer::PRODUCTS_ID;
		}
	...
	public function setDomainsId($v)
	{
		...
		if ($this->domains_id !== $v) {
			$this->domains_id = $v;
			$this->modifiedColumns[] = ProductsDomainsPricesPeer::DOMAINS_ID;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = ProductsDomainsPricesPeer::PRICE;
		}
	...
	public function setVat($v)
	{
		...
		if ($this->vat !== $v) {
			$this->vat = $v;
			$this->modifiedColumns[] = ProductsDomainsPricesPeer::VAT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			throw new PropelException("Error populating ProductsDomainsPrices object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProductsDomainsPricesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProductsDomainsPricesQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProductsDomainsPricesPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		$sql = sprintf(
			'INSERT INTO `products_domains_prices` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProductsDomainsPricesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ProductsDomainsPricesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['ProductsDomainsPrices'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProductsDomainsPrices'][serialize($this->getPrimaryKey())] = true;
		$keys = ProductsDomainsPricesPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductsDomainsPricesPeer::PRODUCTS_ID)) $criteria->add(ProductsDomainsPricesPeer::PRODUCTS_ID, $this->products_id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProductsDomainsPrices (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProductsDomainsPrices Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProductsDomainsPricesPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProductsDomainsPricesPeer();
		}
		return self::$peer;
	}
	...
	public function setProducts(Products $v = null)
	{
		...
		if ($v !== null) {
			$v->addProductsDomainsPrices($this);
		}
	...
	public function getProducts(PropelPDO $con = null)
	{
		if ($this->aProducts === null && ($this->products_id !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aProducts->addProductsDomainsPricess($this);
			 */
		}
	...
	public function getDomains(PropelPDO $con = null)
	{
		if ($this->aDomains === null && ($this->domains_id !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aDomains->addProductsDomainsPricess($this);
			 */
		}
	...
	{
		return (string) $this->exportTo(ProductsDomainsPricesPeer::DEFAULT_STRING_FORMAT);
	}

} // BaseProductsDomainsPrices
