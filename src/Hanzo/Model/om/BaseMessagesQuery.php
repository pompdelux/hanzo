...
abstract class BaseMessagesQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\Messages', $modelAlias = null)
	{
	 ...
	 *
	 * @param     MessagesI18n $messagesI18n  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    MessagesQuery The current query, for fluid interface
	 */
	public function filterByMessagesI18n($messagesI18n, $comparison = null)
	{
		...
		} elseif ($messagesI18n instanceof PropelCollection) {
			return $this
