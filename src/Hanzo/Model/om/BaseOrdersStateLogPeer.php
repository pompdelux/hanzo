...
abstract class BaseOrdersStateLogPeer
{
     ...
     * e.g. OrdersStateLogPeer::$fieldNames[OrdersStateLogPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (OrdersStateLogPeer::ORDERS_ID, OrdersStateLogPeer::STATE, OrdersStateLogPeer::CREATED_AT, OrdersStateLogPeer::MESSAGE, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. OrdersStateLogPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (OrdersStateLogPeer::ORDERS_ID => 0, OrdersStateLogPeer::STATE => 1, OrdersStateLogPeer::CREATED_AT => 2, OrdersStateLogPeer::MESSAGE => 3, ),
    ...
    {
        $toNames = OrdersStateLogPeer::getFieldNames($toType);
        $key = isset(OrdersStateLogPeer::$fieldKeys[$fromType][$name]) ? OrdersStateLogPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(OrdersStateLogPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, OrdersStateLogPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return OrdersStateLogPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(OrdersStateLogPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(OrdersStateLogPeer::DATABASE_NAME);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getOrdersId(), (string) $obj->getState(), (string) $obj->getCreatedAt('U')));
            } // if key === null
            OrdersStateLogPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(OrdersStateLogPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(OrdersStateLogPeer::$instances[$key])) {
                return OrdersStateLogPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        ...
        OrdersStateLogPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(OrdersStateLogPeer::DATABASE_NAME)->getTable(OrdersStateLogPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(OrdersStateLogPeer::DATABASE_NAME);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseOrdersStateLogPeer'));
