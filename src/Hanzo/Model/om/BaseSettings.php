...
abstract class BaseSettings extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\SettingsPeer';
    ...
    public function setCKey($v)
    {
        ...
        if ($this->c_key !== $v) {
            $this->c_key = $v;
            $this->modifiedColumns[] = SettingsPeer::C_KEY;
        }
    ...
    public function setNs($v)
    {
        ...
        if ($this->ns !== $v) {
            $this->ns = $v;
            $this->modifiedColumns[] = SettingsPeer::NS;
        }
    ...
    public function setCValue($v)
    {
        ...
        if ($this->c_value !== $v) {
            $this->c_value = $v;
            $this->modifiedColumns[] = SettingsPeer::C_VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->c_key = ($row[$startcol + 0] !== null) ? (string) $row[$startcol + 0] : null;
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SettingsPeer::CREATED_AT)) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SettingsPeer::C_KEY)) {
            $modifiedColumns[':p' . $index++]  = '`c_key`';
        }
        if ($this->isColumnModified(SettingsPeer::NS)) {
            $modifiedColumns[':p' . $index++]  = '`ns`';
        }
        if ($this->isColumnModified(SettingsPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(SettingsPeer::C_VALUE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setCKey($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SettingsPeer::C_KEY)) $criteria->add(SettingsPeer::C_KEY, $this->c_key);
        if ($this->isColumnModified(SettingsPeer::NS)) $criteria->add(SettingsPeer::NS, $this->ns);
        if ($this->isColumnModified(SettingsPeer::TITLE)) $criteria->add(SettingsPeer::TITLE, $this->title);
        if ($this->isColumnModified(SettingsPeer::C_VALUE)) $criteria->add(SettingsPeer::C_VALUE, $this->c_value);
    ...
    {
        $criteria = new Criteria(SettingsPeer::DATABASE_NAME);
        $criteria->add(SettingsPeer::C_KEY, $this->c_key);
        $criteria->add(SettingsPeer::NS, $this->ns);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCKey()) && (null === $this->getNs());
    }
