...
abstract class BaseSettingsPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CKey', 'Ns', 'Title', 'CValue', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('cKey', 'ns', 'title', 'cValue', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (SettingsPeer::C_KEY, SettingsPeer::NS, SettingsPeer::TITLE, SettingsPeer::C_VALUE, SettingsPeer::CREATED_AT, SettingsPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('C_KEY', 'NS', 'TITLE', 'C_VALUE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('c_key', 'ns', 'title', 'c_value', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CKey' => 0, 'Ns' => 1, 'Title' => 2, 'CValue' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('cKey' => 0, 'ns' => 1, 'title' => 2, 'cValue' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (SettingsPeer::C_KEY => 0, SettingsPeer::NS => 1, SettingsPeer::TITLE => 2, SettingsPeer::C_VALUE => 3, SettingsPeer::CREATED_AT => 4, SettingsPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('C_KEY' => 0, 'NS' => 1, 'TITLE' => 2, 'C_VALUE' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('c_key' => 0, 'ns' => 1, 'title' => 2, 'c_value' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SettingsPeer::C_KEY);
            $criteria->addSelectColumn(SettingsPeer::NS);
            $criteria->addSelectColumn(SettingsPeer::TITLE);
            $criteria->addSelectColumn(SettingsPeer::C_VALUE);
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getCKey(), (string) $obj->getNs()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Settings) {
                $key = serialize(array((string) $value->getCKey(), (string) $value->getNs()));
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(SettingsPeer::C_KEY);
            $value = $criteria->remove(SettingsPeer::C_KEY);
            if ($value) {
                $selectCriteria->add(SettingsPeer::C_KEY, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SettingsPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(SettingsPeer::NS);
            $value = $criteria->remove(SettingsPeer::NS);
            if ($value) {
                $selectCriteria->add(SettingsPeer::NS, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(SettingsPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SettingsPeer::C_KEY, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SettingsPeer::NS, $value[1]));
    ...
    public static function retrieveByPK($c_key, $ns, PropelPDO $con = null) {
        ...
        $criteria = new Criteria(SettingsPeer::DATABASE_NAME);
        $criteria->add(SettingsPeer::C_KEY, $c_key);
        $criteria->add(SettingsPeer::NS, $ns);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseSettingsPeer'));
