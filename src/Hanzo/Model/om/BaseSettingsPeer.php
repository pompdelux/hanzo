...
abstract class BaseSettingsPeer {
	...
	const CLASS_DEFAULT = 'src.Hanzo.Model.Settings';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::C_KEY, self::NS, self::TITLE, self::C_VALUE, self::CREATED_AT, self::UPDATED_AT, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::C_KEY => 0, self::NS => 1, self::TITLE => 2, self::C_VALUE => 3, self::CREATED_AT => 4, self::UPDATED_AT => 5, ),
