...
abstract class BaseProductsImagesCategoriesSortPeer {
	...
	const CLASS_DEFAULT = 'home/un/Documents/Arbejde/Pompdelux/www/hanzo/Symfony/src/Hanzo/Model.ProductsImagesCategoriesSort';
	...
	/**
	 * An identiy map to hold any loaded instances of ProductsImagesCategoriesSort objects.
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::PRODUCTS_ID, self::CATEGORIES_ID, self::PRODUCTS_IMAGES_ID, self::SORT, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::PRODUCTS_ID => 0, self::CATEGORIES_ID => 1, self::PRODUCTS_IMAGES_ID => 2, self::SORT => 3, ),
	 ...
	 *
	 * @param      ProductsImagesCategoriesSort $value A ProductsImagesCategoriesSort object.
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new ProductsImagesCategoriesSortTableMap());
	  }
	}
