...
abstract class BaseOrdersToCouponsPeer {
	...
	const TM_CLASS = 'OrdersToCouponsTableMap';
	...
	/**
	 * An identiy map to hold any loaded instances of OrdersToCoupons objects.
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ORDERS_ID, self::COUPONS_ID, self::AMOUNT, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ORDERS_ID => 0, self::COUPONS_ID => 1, self::AMOUNT => 2, ),
	 ...
	 *
	 * @param      OrdersToCoupons $value A OrdersToCoupons object.
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new OrdersToCouponsTableMap());
	  }
	}
