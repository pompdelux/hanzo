...
abstract class BaseOrdersSyncLog extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\OrdersSyncLogPeer';
    ...
    /**
     * Initializes internal state of BaseOrdersSyncLog object.
     * @see        applyDefaults()
     */
    ...
    public function setOrdersId($v)
    {
        ...
        if ($this->orders_id !== $v) {
            $this->orders_id = $v;
            $this->modifiedColumns[] = OrdersSyncLogPeer::ORDERS_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OrdersSyncLogPeer::CREATED_AT;
            }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[] = OrdersSyncLogPeer::STATE;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = OrdersSyncLogPeer::CONTENT;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrdersSyncLogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrdersSyncLogQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrdersSyncLogPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrdersSyncLogPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrdersSyncLogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrdersSyncLog'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrdersSyncLog'][serialize($this->getPrimaryKey())] = true;
        $keys = OrdersSyncLogPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrdersSyncLogPeer::ORDERS_ID)) $criteria->add(OrdersSyncLogPeer::ORDERS_ID, $this->orders_id);
    ...
    {
        $criteria = new Criteria(OrdersSyncLogPeer::DATABASE_NAME);
        $criteria->add(OrdersSyncLogPeer::ORDERS_ID, $this->orders_id);
        $criteria->add(OrdersSyncLogPeer::CREATED_AT, $this->created_at);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOrdersId()) && (null === $this->getCreatedAt());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrdersSyncLog (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrdersSyncLog Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrdersSyncLogPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrdersSyncLogPeer();
        }
    ...
    public function getOrders(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrders === null && ($this->orders_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrders->addOrdersSyncLogs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrdersSyncLogPeer::DEFAULT_STRING_FORMAT);
    }
