...
abstract class BaseWallPeer
{
    ...
    const TM_CLASS = 'Hanzo\\Model\\map\\WallTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Wall objects.
     ...
     * e.g. WallPeer::$fieldNames[WallPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (WallPeer::ID, WallPeer::PARENT_ID, WallPeer::CUSTOMERS_ID, WallPeer::MESSATE, WallPeer::STATUS, WallPeer::CREATED_AT, WallPeer::UPDATED_AT, ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. WallPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (WallPeer::ID => 0, WallPeer::PARENT_ID => 1, WallPeer::CUSTOMERS_ID => 2, WallPeer::MESSATE => 3, WallPeer::STATUS => 4, WallPeer::CREATED_AT => 5, WallPeer::UPDATED_AT => 6, ),
    ...
    {
        $toNames = WallPeer::getFieldNames($toType);
        $key = isset(WallPeer::$fieldKeys[$fromType][$name]) ? WallPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(WallPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, WallPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return WallPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(WallPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(WallPeer::DATABASE_NAME);
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(WallPeer::$instances[$key])) {
                return WallPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (WallPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        WallPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(WallPeer::DATABASE_NAME)->getTable(WallPeer::TABLE_NAME);
    }
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseWallPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Hanzo\Model\map\WallTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(WallPeer::DATABASE_NAME);
...
EventDispatcherProxy::trigger(array('construct','peer.construct'), new PeerEvent('Hanzo\Model\om\BaseWallPeer'));
