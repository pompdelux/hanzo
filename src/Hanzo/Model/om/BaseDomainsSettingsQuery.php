...
abstract class BaseDomainsSettingsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\DomainsSettings', $modelAlias = null)
	{
	...
	public static function create($modelAlias = null, $criteria = null)
	{
		...
		$query = new DomainsSettingsQuery();
		if (null !== $modelAlias) {
	 ...
	 *
	 * @return    DomainsSettings|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     Domains|PropelCollection $domains The related object(s) to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    DomainsSettingsQuery The current query, for fluid interface
	 */
	public function filterByDomains($domains, $comparison = null)
	{
		...
		} elseif ($domains instanceof PropelCollection) {
			if (null === $comparison) {
				$comparison = Criteria::IN;
			}
			return $this
