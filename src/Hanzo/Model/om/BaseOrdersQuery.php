...
abstract class BaseOrdersQuery extends ModelCriteria
{
	 ...
	 *
	 * @return    Orders|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     Events|PropelCollection $events The related object(s) to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    OrdersQuery The current query, for fluid interface
	 */
	 ...
	 *
	 * @param     OrdersAttributes $ordersAttributes  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    OrdersQuery The current query, for fluid interface
	 */
	public function filterByOrdersAttributes($ordersAttributes, $comparison = null)
	{
		...
		} elseif ($ordersAttributes instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     OrdersSyncLog $ordersSyncLog  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    OrdersQuery The current query, for fluid interface
	 */
	public function filterByOrdersSyncLog($ordersSyncLog, $comparison = null)
	{
		...
		} elseif ($ordersSyncLog instanceof PropelCollection) {
			return $this
