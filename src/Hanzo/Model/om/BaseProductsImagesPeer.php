...
abstract class BaseProductsImagesPeer {
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::PRODUCTS_ID, self::IMAGE, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::PRODUCTS_ID => 1, self::IMAGE => 2, ),
	 ...
	 *
	 * @param      ProductsImages $value A ProductsImages object.
