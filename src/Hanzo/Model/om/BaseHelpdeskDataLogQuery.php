 ...
 *
 * @method HelpdeskDataLogQuery groupByKey() Group by the key column
 * @method HelpdeskDataLogQuery groupByData() Group by the data column
 * @method HelpdeskDataLogQuery groupByCreatedAt() Group by the created_at column
 *
 * @method HelpdeskDataLogQuery leftJoin($relation) Adds a LEFT JOIN clause to the query
 * @method HelpdeskDataLogQuery rightJoin($relation) Adds a RIGHT JOIN clause to the query
 * @method HelpdeskDataLogQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
...
{
    /**
     * Initializes internal state of BaseHelpdeskDataLogQuery object.
     *
     ...
     *
     * @return   HelpdeskDataLog|HelpdeskDataLog[]|mixed the result, formatted by the current formatter
     */
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|HelpdeskDataLog[]|mixed the list of results, formatted by the current formatter
     */
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return HelpdeskDataLogQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(HelpdeskDataLogPeer::KEY, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(HelpdeskDataLogPeer::KEY, $keys, Criteria::IN);
    }
    ...
    public function filterByKey($key = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HelpdeskDataLogPeer::KEY, $key, $comparison);
    }
    ...
    public function filterByData($data = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HelpdeskDataLogPeer::DATA, $data, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(HelpdeskDataLogPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(HelpdeskDataLogPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(HelpdeskDataLogPeer::CREATED_AT, $createdAt, $comparison);
    }

    /**
     * Exclude object from result
     *
     * @param   HelpdeskDataLog $helpdeskDataLog Object to remove from the list of results
     *
     * @return HelpdeskDataLogQuery The current query, for fluid interface
     */
    public function prune($helpdeskDataLog = null)
    {
        if ($helpdeskDataLog) {
            $this->addUsingAlias(HelpdeskDataLogPeer::KEY, $helpdeskDataLog->getKey(), Criteria::NOT_EQUAL);
        }
