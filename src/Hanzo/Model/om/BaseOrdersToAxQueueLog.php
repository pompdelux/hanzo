...
abstract class BaseOrdersToAxQueueLog extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\OrdersToAxQueueLogPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrdersToAxQueueLogPeer
     */
    ...
    public function setQueueId($v)
    {
        ...
        if ($this->queue_id !== $v) {
            $this->queue_id = $v;
            $this->modifiedColumns[] = OrdersToAxQueueLogPeer::QUEUE_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OrdersToAxQueueLogPeer::CREATED_AT;
            }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrdersToAxQueueLogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrdersToAxQueueLogQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                OrdersToAxQueueLogPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrdersToAxQueueLogPeer::ORDERS_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO `orders_to_ax_queue_log` (%s) VALUES (%s)',
    ...
    {
        $pos = OrdersToAxQueueLogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $alreadyDumpedObjects['OrdersToAxQueueLog'][serialize($this->getPrimaryKey())] = true;
        $keys = OrdersToAxQueueLogPeer::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(OrdersToAxQueueLogPeer::DATABASE_NAME);
        $criteria->add(OrdersToAxQueueLogPeer::ORDERS_ID, $this->orders_id);
        $criteria->add(OrdersToAxQueueLogPeer::QUEUE_ID, $this->queue_id);
        $criteria->add(OrdersToAxQueueLogPeer::CREATED_AT, $this->created_at);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOrdersId()) && (null === $this->getQueueId()) && (null === $this->getCreatedAt());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrdersToAxQueueLog (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrdersToAxQueueLog Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrdersToAxQueueLogPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrdersToAxQueueLogPeer();
        }
    ...
    {
        return (string) $this->exportTo(OrdersToAxQueueLogPeer::DEFAULT_STRING_FORMAT);
    }
