...
abstract class BaseCmsThreadQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\CmsThread', $modelAlias = null)
	{
	 ...
	 *
	 * @return    CmsThread|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     CmsThreadI18n $cmsThreadI18n  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    CmsThreadQuery The current query, for fluid interface
	 */
	public function filterByCmsThreadI18n($cmsThreadI18n, $comparison = null)
	{
		...
		} elseif ($cmsThreadI18n instanceof PropelCollection) {
			return $this
