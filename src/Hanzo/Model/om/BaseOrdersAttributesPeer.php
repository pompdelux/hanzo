...
abstract class BaseOrdersAttributesPeer {
	...
	const CLASS_DEFAULT = 'home/un/Documents/Arbejde/Pompdelux/www/hanzo/Symfony/src/Hanzo/Model.OrdersAttributes';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CKey', 'Ns', 'CValue', 'OrdersId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('cKey', 'ns', 'cValue', 'ordersId', ),
		BasePeer::TYPE_COLNAME => array (self::C_KEY, self::NS, self::C_VALUE, self::ORDERS_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('C_KEY', 'NS', 'C_VALUE', 'ORDERS_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('c_key', 'ns', 'c_value', 'orders_id', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CKey' => 0, 'Ns' => 1, 'CValue' => 2, 'OrdersId' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('cKey' => 0, 'ns' => 1, 'cValue' => 2, 'ordersId' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::C_KEY => 0, self::NS => 1, self::C_VALUE => 2, self::ORDERS_ID => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('C_KEY' => 0, 'NS' => 1, 'C_VALUE' => 2, 'ORDERS_ID' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('c_key' => 0, 'ns' => 1, 'c_value' => 2, 'orders_id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(OrdersAttributesPeer::C_KEY, $value[0]);
