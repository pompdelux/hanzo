...
abstract class BaseDomainsSettings extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\DomainsSettingsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DomainsSettingsPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DomainsSettingsPeer::ID;
        }
    ...
    public function setDomainKey($v)
    {
        ...
        if ($this->domain_key !== $v) {
            $this->domain_key = $v;
            $this->modifiedColumns[] = DomainsSettingsPeer::DOMAIN_KEY;
        }

        if ($this->aDomains !== null && $this->aDomains->getDomainKey() !== $v) {
            $this->aDomains = null;
        }
    ...
    public function setCKey($v)
    {
        ...
        if ($this->c_key !== $v) {
            $this->c_key = $v;
            $this->modifiedColumns[] = DomainsSettingsPeer::C_KEY;
        }
    ...
    public function setNs($v)
    {
        ...
        if ($this->ns !== $v) {
            $this->ns = $v;
            $this->modifiedColumns[] = DomainsSettingsPeer::NS;
        }
    ...
    public function setCValue($v)
    {
        ...
        if ($this->c_value !== $v) {
            $this->c_value = $v;
            $this->modifiedColumns[] = DomainsSettingsPeer::C_VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->c_value = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            throw new PropelException("Error populating DomainsSettings object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aDomains !== null && $this->domain_key !== $this->aDomains->getDomainKey()) {
            $this->aDomains = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DomainsSettingsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DomainsSettingsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DomainsSettingsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `domains_settings` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DomainsSettingsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DomainsSettingsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DomainsSettings'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DomainsSettings'][$this->getPrimaryKey()] = true;
        $keys = DomainsSettingsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setCValue($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DomainsSettingsPeer::ID)) $criteria->add(DomainsSettingsPeer::ID, $this->id);
        if ($this->isColumnModified(DomainsSettingsPeer::DOMAIN_KEY)) $criteria->add(DomainsSettingsPeer::DOMAIN_KEY, $this->domain_key);
        if ($this->isColumnModified(DomainsSettingsPeer::C_KEY)) $criteria->add(DomainsSettingsPeer::C_KEY, $this->c_key);
        if ($this->isColumnModified(DomainsSettingsPeer::NS)) $criteria->add(DomainsSettingsPeer::NS, $this->ns);
        if ($this->isColumnModified(DomainsSettingsPeer::C_VALUE)) $criteria->add(DomainsSettingsPeer::C_VALUE, $this->c_value);
    ...
    {
        $criteria = new Criteria(DomainsSettingsPeer::DATABASE_NAME);
        $criteria->add(DomainsSettingsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of DomainsSettings (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DomainsSettings Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DomainsSettingsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DomainsSettingsPeer();
        }
    ...
    {
        if ($v === null) {
            $this->setDomainKey(NULL);
        } else {
            $this->setDomainKey($v->getDomainKey());
        }
    ...
    public function getDomains(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDomains === null && (($this->domain_key !== "" && $this->domain_key !== null)) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDomains->addDomainsSettingss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DomainsSettingsPeer::DEFAULT_STRING_FORMAT);
    }
