...
abstract class BaseGroups extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'Hanzo\\Model\\GroupsPeer';
	...
	public function setDiscount($v)
	{
		...
		if ($this->discount !== $v) {
			$this->discount = $v;
			$this->modifiedColumns[] = GroupsPeer::DISCOUNT;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GroupsPeer::DISCOUNT)) $criteria->add(GroupsPeer::DISCOUNT, $this->discount);
	 ...
	 * @return     PropelCollection|array Customers[] List of Customers objects
	 */
	public function getCustomerssJoinLanguages($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CustomersQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Customers[] List of Customers objects
	 */
	public function getCustomerssJoinCountriesRelatedByCountriesId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CustomersQuery::create(null, $criteria);
		$query->joinWith('CountriesRelatedByCountriesId', $join_behavior);
	 ...
	 * @return     PropelCollection|array Customers[] List of Customers objects
	 */
	public function getCustomerssJoinCountriesRelatedByBillingCountriesId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CustomersQuery::create(null, $criteria);
	 ...
	 * @return     PropelCollection|array Customers[] List of Customers objects
	 */
	public function getCustomerssJoinCountriesRelatedByDeliveryCountriesId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = CustomersQuery::create(null, $criteria);
