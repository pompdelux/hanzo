...
abstract class BaseOrdersVersionsQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\OrdersVersions', $modelAlias = null)
	{
	 ...
	 * </code>
	 *
	 * @param     array[$orders_id, $version_id] $key Primary key to use for the query
	 * @param     PropelPDO $con an optional connection object
	 *
	 * @return    OrdersVersions|array|mixed the result, formatted by the current formatter
	 */
