 ...
 *
 * @method ProductsImagesQuery leftJoinProductsImagesToLooks($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProductsImagesToLooks relation
 * @method ProductsImagesQuery rightJoinProductsImagesToLooks($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProductsImagesToLooks relation
 * @method ProductsImagesQuery innerJoinProductsImagesToLooks($relationAlias = null) Adds a INNER JOIN clause to the query using the ProductsImagesToLooks relation
 *
...
abstract class BaseProductsImagesQuery extends ModelCriteria
{
    ...
    public function filterByProductsImagesToLooks($productsImagesToLooks, $comparison = null)
    {
        if ($productsImagesToLooks instanceof ProductsImagesToLooks) {
            return $this
                ->addUsingAlias(ProductsImagesPeer::ID, $productsImagesToLooks->getProductsImagesId(), $comparison);
