...
abstract class BaseRedirects extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\RedirectsPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RedirectsPeer::ID;
        }
    ...
    public function setSource($v)
    {
        ...
        if ($this->source !== $v) {
            $this->source = $v;
            $this->modifiedColumns[] = RedirectsPeer::SOURCE;
        }
    ...
    public function setTarget($v)
    {
        ...
        if ($this->target !== $v) {
            $this->target = $v;
            $this->modifiedColumns[] = RedirectsPeer::TARGET;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RedirectsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RedirectsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RedirectsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RedirectsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RedirectsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Redirects'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Redirects'][$this->getPrimaryKey()] = true;
        $keys = RedirectsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(RedirectsPeer::DATABASE_NAME);
        $criteria->add(RedirectsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Redirects (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Redirects Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RedirectsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RedirectsPeer();
        }
    ...
    {
        return (string) $this->exportTo(RedirectsPeer::DEFAULT_STRING_FORMAT);
    }
