...
abstract class BaseOrdersVersions extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Hanzo\\Model\\OrdersVersionsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrdersVersionsPeer
     */
    ...
    public function setOrdersId($v)
    {
        ...
        if ($this->orders_id !== $v) {
            $this->orders_id = $v;
            $this->modifiedColumns[] = OrdersVersionsPeer::ORDERS_ID;
        }
    ...
    public function setVersionId($v)
    {
        ...
        if ($this->version_id !== $v) {
            $this->version_id = $v;
            $this->modifiedColumns[] = OrdersVersionsPeer::VERSION_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = OrdersVersionsPeer::CREATED_AT;
            }
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[] = OrdersVersionsPeer::CONTENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            throw new PropelException("Error populating OrdersVersions object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrdersVersionsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrdersVersionsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrdersVersionsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `orders_versions` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrdersVersionsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrdersVersionsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OrdersVersions'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrdersVersions'][serialize($this->getPrimaryKey())] = true;
        $keys = OrdersVersionsPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrdersVersionsPeer::ORDERS_ID)) $criteria->add(OrdersVersionsPeer::ORDERS_ID, $this->orders_id);
        if ($this->isColumnModified(OrdersVersionsPeer::VERSION_ID)) $criteria->add(OrdersVersionsPeer::VERSION_ID, $this->version_id);
        if ($this->isColumnModified(OrdersVersionsPeer::CREATED_AT)) $criteria->add(OrdersVersionsPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(OrdersVersionsPeer::CONTENT)) $criteria->add(OrdersVersionsPeer::CONTENT, $this->content);
    ...
    {
        $criteria = new Criteria(OrdersVersionsPeer::DATABASE_NAME);
        $criteria->add(OrdersVersionsPeer::ORDERS_ID, $this->orders_id);
        $criteria->add(OrdersVersionsPeer::VERSION_ID, $this->version_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getOrdersId()) && (null === $this->getVersionId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of OrdersVersions (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrdersVersions Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrdersVersionsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrdersVersionsPeer();
        }
    ...
    public function getOrders(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrders === null && ($this->orders_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrders->addOrdersVersionss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrdersVersionsPeer::DEFAULT_STRING_FORMAT);
    }
