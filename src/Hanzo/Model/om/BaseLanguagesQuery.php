...
abstract class BaseLanguagesQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'default', $modelName = 'Hanzo\\Model\\Languages', $modelAlias = null)
	{
	 ...
	 *
	 * @return    Languages|array|mixed the result, formatted by the current formatter
	 */
	 ...
	 *
	 * @param     ProductsWashingInstructions $productsWashingInstructions  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    LanguagesQuery The current query, for fluid interface
	 */
