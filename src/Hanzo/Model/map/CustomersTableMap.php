...
class CustomersTableMap extends TableMap
{
	...
	public function buildRelations()
	{
		...
		$this->addRelation('CustomersGotiaAttributes', 'Hanzo\\Model\\CustomersGotiaAttributes', RelationMap::ONE_TO_MANY, array('id' => 'customers_id', ), 'CASCADE', null, 'CustomersGotiaAttributess');
